...
const AppRoutes = () => {
  ...
  <Routes>
    ...
    <Route
      ...
      element={withShellRoles(<AcademyExam />, ['admin', 'worker'])}
    />
    <Route
      path="/academy/:moduleId"
      element={withShellRoles(<AcademyModule />, ['admin', 'worker'])}
    />
    <Route
      path="/tools"
    ...
    <Route
      path="/blog/*"
      element={
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#0a0a0a]"><div className="h-8 w-8 animate-spin rounded-full border-2 border-[#f59e0b] border-t-transparent" /></div>}>
          <BlogRoutes />
        </Suspense>
      }
    />
