    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
        ...
        <Section title={t('companyPostJob.descriptionRequirements')} icon={FileText}>
          <TextArea label={t('companyPostJob.jobDescription')} name="description" value={form.description} onChange={handleChange} placeholder={t('companyPostJob.jobDescriptionPlaceholder')} rows={5} />
