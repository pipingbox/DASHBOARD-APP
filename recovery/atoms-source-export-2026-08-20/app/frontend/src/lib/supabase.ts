...
export const SUPABASE_URL = 'https://mwdauubztjxkbrefirbg.supabase.co';
...
// Detect if running inside an iframe (e.g., Atoms App Viewer)
...
export const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
  auth: {
    ...
    // Disable URL session detection in iframes to prevent hangs
